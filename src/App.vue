...
const settings = ref<Settings>({ weather_city_id: "", atcoder_id: "", widget_interval: 0, using_widgets: [], auto_fullscreen: false, auto_hide_cursor: false, using_sports_news: [], nightmode_range: { start: "22:00:00", end: "06:30:00" }, use_sound_when_disaster: false });
const osType = type();
